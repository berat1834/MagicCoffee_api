...
CATEGORIES = [
    ...
    {"id": "deneme", "name": "Deneme Kategori", "eyebrow": "Test ürünleri", "position": 8, "active": True},
]
...
PRODUCTS = [
    {"id": "latte", "categoryId": "espresso", "name": "Caffe Latte", "description": "Espresso, kadifemsi süt ve ince köpük.", "price": 92, "kind": "coffee", "image": "/images/products/latte.svg", "emoji": "☕", "customizable": True, "popular": True, "active": True, "position": 0, "stockQuantity": 80, "criticalStock": 10, "stockTrackingEnabled": True, "stockSellable": True, "customization": customization(milk_required=True)},
    {"id": "americano", "categoryId": "espresso", "name": "Americano", "description": "Espresso ve sıcak suyla dengeli klasik.", "price": 76, "kind": "coffee", "image": "/images/products/americano.svg", "emoji": "☕", "customizable": True, "popular": False, "active": True, "position": 1, "stockQuantity": None, "criticalStock": None, "stockTrackingEnabled": False, "stockSellable": True, "customization": customization()},
    {"id": "flat-white", "categoryId": "espresso", "name": "Flat White", "description": "Yoğun espresso ve mikro köpüklü süt.", "price": 98, "kind": "coffee", "image": "/images/products/flat-white.svg", "emoji": "☕", "customizable": True, "popular": True, "active": True, "position": 2, "stockQuantity": 45, "criticalStock": 8, "stockTrackingEnabled": True, "stockSellable": True, "customization": customization(milk_required=True)},
    {"id": "batch-brew", "categoryId": "filter", "name": "Günlük Filtre Kahve", "description": "Taze çekilmiş çekirdeklerle günlük demleme.", "price": 68, "kind": "coffee", "image": "/images/products/filter-coffee.svg", "emoji": "☕", "customizable": True, "popular": False, "active": True, "position": 3, "stockQuantity": None, "criticalStock": None, "stockTrackingEnabled": False, "stockSellable": True, "customization": customization()},
    {"id": "cold-brew", "categoryId": "cold", "name": "Cold Brew", "description": "Uzun demlenmiş, yumuşak içimli soğuk kahve.", "price": 95, "kind": "cold-coffee", "image": "/images/products/cold-brew.svg", "emoji": "CB", "customizable": True, "popular": True, "active": True, "position": 4, "stockQuantity": 36, "criticalStock": 6, "stockTrackingEnabled": True, "stockSellable": True, "customization": customization(cold=True)},
    {"id": "caramel-frappe", "categoryId": "frappe", "name": "Karamel Frappe", "description": "Süt, karamel ve buzla hazırlanan tatlı içim.", "price": 118, "kind": "cold-coffee", "image": "/images/products/caramel-frappe.svg", "emoji": "FR", "customizable": True, "popular": True, "active": True, "position": 5, "stockQuantity": 24, "criticalStock": 5, "stockTrackingEnabled": True, "stockSellable": True, "customization": customization(cold=True, milk_required=True)},
    {"id": "earl-grey", "categoryId": "tea", "name": "Earl Grey", "description": "Bergamot aromalı siyah çay.", "price": 52, "kind": "simple", "image": "/images/products/earl-grey.svg", "emoji": "TEA", "customizable": False, "popular": False, "active": True, "position": 6, "stockQuantity": None, "criticalStock": None, "stockTrackingEnabled": False, "stockSellable": True, "customization": {}},
    {"id": "lemonade", "categoryId": "other-drinks", "name": "Ev Yapımı Limonata", "description": "Taze limon, nane ve buz.", "price": 72, "kind": "simple", "image": "/images/products/lemonade.svg", "emoji": "LIM", "customizable": False, "popular": False, "active": True, "position": 7, "stockQuantity": 18, "criticalStock": 4, "stockTrackingEnabled": True, "stockSellable": True, "customization": {}},
    {"id": "san-sebastian", "categoryId": "desserts", "name": "San Sebastian Cheesecake", "description": "Kremamsı dokulu cheesecake.", "price": 135, "kind": "simple", "image": "/images/products/san-sebastian.svg", "emoji": "CAKE", "customizable": False, "popular": True, "active": True, "position": 8, "stockQuantity": 12, "criticalStock": 3, "stockTrackingEnabled": True, "stockSellable": True, "customization": {}},
    {"id": "croissant", "categoryId": "snacks", "name": "Tereyağlı Kruvasan", "description": "Kat kat hamur, sade ve sıcak servis.", "price": 84, "kind": "simple", "image": "/images/products/croissant.svg", "emoji": "CR", "customizable": False, "popular": False, "active": True, "position": 9, "stockQuantity": 20, "criticalStock": 4, "stockTrackingEnabled": True, "stockSellable": True, "customization": {}},
    {"id": "deneme-urun", "categoryId": "deneme", "name": "Deneme Ürün", "description": "Panel ve kiosk görünürlüğünü test etmek için örnek ürün.", "price": 10, "kind": "simple", "image": "/images/products/test-product.svg", "emoji": "TEST", "customizable": False, "popular": False, "active": True, "position": 10, "stockQuantity": None, "criticalStock": None, "stockTrackingEnabled": False, "stockSellable": True, "customization": {}},
]
