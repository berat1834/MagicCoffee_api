...
PRODUCTS = [
    ...
    {"id": "san-sebastian", "categoryId": "desserts", "name": "San Sebastian Cheesecake", "description": "KremamsÄ± dokulu cheesecake.", "price": 135, "kind": "simple", "image": "/images/products/san-sebastian.svg", "emoji": "CAKE", "customizable": False, "popular": True, "active": True, "position": 8, "stockQuantity": 12, "criticalStock": 3, "stockTrackingEnabled": True, "stockSellable": True, "customization": {}},
    {"id": "croissant", "categoryId": "snacks", "name": "TereyaÄŸlÄ± Kruvasan", "description": "Kat kat hamur, sade ve sÄ±cak servis.", "price": 84, "kind": "simple", "image": "/images/products/croissant.svg", "emoji": "CR", "customizable": False, "popular": False, "active": True, "position": 9, "stockQuantity": 20, "criticalStock": 4, "stockTrackingEnabled": True, "stockSellable": True, "customization": {}},
