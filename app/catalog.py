...
PRODUCTS = [
    ...
    {"id": "batch-brew", "categoryId": "filter", "name": "Günlük Filtre Kahve", "description": "Taze çekilmiş çekirdeklerle günlük demleme.", "price": 68, "kind": "coffee", "image": "/images/products/filter-coffee.png", "emoji": "☕", "customizable": True, "popular": False, "active": True, "position": 3, "stockQuantity": None, "criticalStock": None, "stockTrackingEnabled": False, "stockSellable": True, "customization": customization()},
    {"id": "cold-brew", "categoryId": "cold", "name": "Cold Brew", "description": "Uzun demlenmiş, yumuşak içimli soğuk kahve.", "price": 95, "kind": "cold-coffee", "image": "/images/products/cold-brew.png", "emoji": "CB", "customizable": True, "popular": True, "active": True, "position": 4, "stockQuantity": 36, "criticalStock": 6, "stockTrackingEnabled": True, "stockSellable": True, "customization": customization(cold=True)},
    ...
    {"id": "croissant", "categoryId": "snacks", "name": "Tereyağlı Kruvasan", "description": "Kat kat hamur, sade ve sıcak servis.", "price": 84, "kind": "simple", "image": "/images/products/croissant.png", "emoji": "CR", "customizable": False, "popular": False, "active": True, "position": 9, "stockQuantity": 20, "criticalStock": 4, "stockTrackingEnabled": True, "stockSellable": True, "customization": {}},
